...
const  RegisterForm:React.FC<IRegisterFormProps>=(props)=>{
    ...
    <Row>
        ...
        <Form.Control type="text"  onChange={(e) => setFname(e.target.value)} placeholder="" />
      </Form.Group>
      <Form.Group className="mb-3" controlId="formBasicEmail">
        <Form.Label>Last Name</Form.Label>
        <Form.Control type="text"  onChange={(e) => setLname(e.target.value)} placeholder="" />
      </Form.Group>
      <Form.Group className="mb-3" controlId="formBasicEmail">
      ...
      <Form.Group className="mb-3" controlId="formBasicEmail">
        ...
        <Form.Control type="date" onChange={(e) => setDob(e.target.value)} placeholder="" />
